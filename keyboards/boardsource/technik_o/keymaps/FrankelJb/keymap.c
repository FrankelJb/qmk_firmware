...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_ortho_4x12(
     ...
     LGUI_T(KC_A), LALT_T(KC_S), LCTL_T(KC_D), LSFT_T(KC_F), KC_G,   XXXXXXX, XXXXXXX, KC_H,   LSFT_T(KC_J), LCTL_T(KC_K), LALT_T(KC_L), LGUI_T(KC_QUOT),
     KC_Z,         KC_X,         KC_C,         KC_V,         KC_B,   XXXXXXX, XXXXXXX, KC_N,   KC_M,         KC_COMM,      KC_DOT,       KC_SLASH,
     XXXXXXX,      XXXXXXX,      L3_ESC,       L1_SPC,       L2_TAB, XXXXXXX, XXXXXXX, L5_ENT, L4_BSPC,      L6_DEL,       XXXXXXX,      XXXXXXX
  ),

  [_LAYER1] = LAYOUT_ortho_4x12(
    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    XXXXXXX, XXXXXXX, KC_UNDO, KC_CUT,  KC_COPY,KC_PSTE, KC_PSCR,
    KC_GRV,  KC_BSLS, KC_LCTL, KC_LGUI, KC_LALT, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,  KC_RGHT, KC_SCLN,
    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_BSLS, XXXXXXX, XXXXXXX, KC_HOME, KC_PGDN, KC_PGUP,KC_END,  XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_ENT,  KC_BSPC, KC_DEL, XXXXXXX, XXXXXXX
  ),

  [_LAYER2] = LAYOUT_ortho_4x12(
    KC_1,    KC_2,    KC_3,     KC_4,   KC_5,    XXXXXXX, XXXXXXX, KC_7,    KC_7,    KC_8,    KC_9,    KC_0,
    KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX,
    XXXXXXX, XXXXXXX, CC_YGC,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, CC_ARRW, XXXXXXX,
  ...
  [_LAYER3] = LAYOUT_ortho_4x12(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_BTN2, KC_BTN1, KC_BTN3, XXXXXXX, XXXXXXX
  ),

  [_LAYER4] = LAYOUT_ortho_4x12(
    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   XXXXXXX, XXXXXXX, KC_F8,   KC_F7,   KC_F8,   KC_F9,   KC_F10,
    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    XXXXXXX, XXXXXXX, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,
    KC_PMNS, KC_PEQL, KC_LBRC, KC_RBRC, KC_BSPC, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_COMM, KC_DOT,  KC_PSLS,
    XXXXXXX, XXXXXXX, KC_DEL,  KC_BSPC, KC_ENT,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),

  [_LAYER5] = LAYOUT_ortho_4x12(
    KC_F11,  KC_F12,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_BSPC,
    KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, XXXXXXX, XXXXXXX, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN,
    KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_BSLS, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, MO(7),   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),

  [_LAYER6] = LAYOUT_ortho_4x12(
    XXXXXXX, XXXXXXX, KC_LBRC, KC_RBRC, KC_PIPE, XXXXXXX, XXXXXXX, KC_PMNS, KC_7,    KC_8,    KC_9,    KC_PLUS,
    KC_GRV,  KC_PIPE, KC_LCBR, KC_RCBR, KC_SCLN, XXXXXXX, XXXXXXX, KC_PEQL, KC_4,    KC_5,    KC_6,    XXXXXXX,
    XXXXXXX, XXXXXXX, KC_LPRN, KC_RPRN, KC_DOT,  XXXXXXX, XXXXXXX, KC_0,    KC_1,    KC_2,    KC_3,    KC_SLSH,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),


  [_LAYER7] = LAYOUT_ortho_4x12(
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, CG_SWAP, CG_NORM, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, TG(8),   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [_LAYER8] = LAYOUT_ortho_4x12(
    ...
    KC_A,    KC_S,    KC_D,    KC_F,    _______, _______, _______, _______, _______, _______, _______, _______,
...
const uint8_t PROGMEM solid_layers[] = {0, 1, 2, 3, 8};
