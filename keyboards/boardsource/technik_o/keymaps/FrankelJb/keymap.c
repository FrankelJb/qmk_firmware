...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_ortho_4x12(
    LT(5,KC_TAB),   KC_Q,           KC_W,    LT(6,KC_E),     KC_R,    KC_T,    KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_BSPC,
    LT(3,KC_ESCAPE),LGUI_T(KC_A),    LALT_T(KC_S),           LCTL_T(KC_D),           LSFT_T(KC_F),    KC_G,           KC_H,           LSFT_T(KC_J),           LCTL_T(KC_K),           LALT_T(KC_L),           LGUI_T(KC_SCLN),LT(5,KC_QUOTE),
    KC_LSFT,      KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,           KC_N,           KC_M,           KC_COMM,       KC_DOT,         KC_SLASH,       RSFT_T(KC_ENTER),
    XXXXXXX, XXXXXXX, XXXXXXX, L3_ESC, L1_SPC,   L2_TAB,   L5_ENT, L4_BSPC,L6_DEL, XXXXXXX, XXXXXXX, XXXXXXX
  ),

  // [_LAYER1] = LAYOUT_ortho_4x12(
  //   XXXXXXX, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_UNDO, KC_CUT, KC_COPY,KC_PSTE, XXXXXXX, KC_BSPC,
  //   XXXXXXX, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, TG(9),   KC_LEFT, KC_DOWN,  KC_UP,KC_RGHT, XXXXXXX, XXXXXXX,
  ...
  [_LAYER1] = LAYOUT_ortho_4x12(
    XXXXXXX, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_UNDO, KC_CUT, KC_COPY,KC_PSTE, XXXXXXX, KC_BSPC,
    XXXXXXX, XXXXXXX, XXXXXXX, KC_LGUI, KC_LALT, XXXXXXX, KC_LEFT, KC_DOWN,  KC_UP,KC_RGHT, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME, KC_PGDN,KC_PGUP,KC_END,  XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_ENT,  KC_BSPC, KC_DEL,XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [_LAYER2] = LAYOUT_ortho_4x12(
    ...
    KC_TILD, KC_1,   KC_2,     KC_3,   KC_4,     KC_5,     KC_6,   KC_7,   KC_8,   KC_9,    KC_0,    XXXXXXX,
    MOD_LSFT,KC_MINUS,KC_EQUAL,KC_LBRC,KC_RBRC,  XXXXXXX,  XXXXXXX,XXXXXXX,KC_COMM,KC_DOT,  KC_PSLS, MOD_RSFT,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,  KC_ENT, KC_BSPC,KC_DEL, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [_LAYER3] = LAYOUT_ortho_4x12(
    ...
    MOD_LSFT,XXXXXXX, XXXXXXX, ST_MACRO_0,XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, ST_ARROW_MACRO,XXXXXXX, XXXXXXX,
  ...
  [_LAYER7] = LAYOUT_ortho_4x12(
    XXXXXXX, XXXXXXX, KC_MS_BTN1,     KC_MS_UP,       KC_MS_BTN2,  XXXXXXX, RGB_MOD, XXXXXXX,XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, KC_MS_LEFT,     KC_MS_DOWN,     KC_MS_RIGHT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
